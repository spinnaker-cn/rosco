...
It presently supports producing Alibaba Cloud images, Google Compute Engine images, Huawei Cloud images, He Cloud images, AWS amis and Azure images. It relies on packer and can be easily extended to support additional platforms.
